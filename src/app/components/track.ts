...
const STORAGE_KEYS = {
  referrer: "atlas_tx_first_referrer",
  source: "atlas_tx_first_utm_source",
  medium: "atlas_tx_first_utm_medium",
  campaign: "atlas_tx_first_utm_campaign",
} as const;
...
function toExternalHostname(raw: string): string {
  ...
  try {
    ...
    if (url.hostname.includes("atlastexas") || url.hostname.includes("atlastx")) return "";
